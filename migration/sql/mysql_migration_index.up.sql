...
CREATE UNIQUE INDEX `rbac_role_rbac_rule_idx` ON rbac_rule (name, parent_type, parent_id);
CREATE INDEX `rbac_role_rbac_rule_checker_idx` ON rbac_rule (parent_type, parent_id);
